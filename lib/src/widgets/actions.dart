...
ActionItem feedActionCreateNew(BuildContext context) =>
    ActionItem(name: l(context).action_createNew, icon: Symbols.create_rounded);
...
ActionItem feedActionRefresh(BuildContext context) =>
    ActionItem(name: l(context).action_refresh, icon: Symbols.refresh_rounded);
ActionItem feedActionSetFilter(BuildContext context) => ActionItem(
  name: l(context).action_setFilter,
  icon: Symbols.filter_alt_rounded,
);
ActionItem feedActionSetSort(BuildContext context) =>
    ActionItem(name: l(context).action_setSort, icon: Symbols.sort_rounded);
ActionItem feedActionSetView(BuildContext context) =>
    ActionItem(name: l(context).action_setView, icon: Symbols.tab_rounded);
...
SelectionMenu<ActionLocation> actionLocationSelect(BuildContext context) =>
    SelectionMenu(l(context).action_setLocation, [
      SelectionMenuItem(
...
ActionItem swipeActionMarkRead(BuildContext context) => ActionItem(
  name: l(context).action_markRead,
