...
abstract class ProfileRequired with _$ProfileRequired {
  ...
  const factory ProfileRequired({
    ...
    required PostMode postMode,
    required bool splitVotes,
  ...
  factory ProfileRequired.fromOptional(
    ...
    postMode: profile?.postMode ?? defaultProfile.postMode,
    splitVotes: profile?.splitVotes ?? defaultProfile.splitVotes,
    hideActionButtons:
...
abstract class ProfileOptional
  ...
  ProfileOptional merge(ProfileOptional? other) {
    ...
    return ProfileOptional(
      ...
      postMode: other.postMode ?? postMode,
      splitVotes: other.splitVotes ?? splitVotes,
...
Object? _parseFeedDefaultCombinedSort(Map<dynamic, dynamic> json, String name) {
